	...
	<div class="card-body">
		<div class="container-fluid">
			<form method="post" action="{{route('students.store')}}">
                ...
                <h5 class="my-5">Course Informations</h5>
                <div class="row">
                ...
                <!-- ----------------------------- -->
                   <div class="form-group col-md-6">
                	<label for="inputBatch">Choose Batch:</label>
                	<select name="batch_id" class="form-control" disabled="disabled" id="batch">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#course').change(function(){
			...
			$.post("{{route('courses.batches')}}",{id:cid},function(response){
